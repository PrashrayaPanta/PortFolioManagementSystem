  ...
  return (
    <section className={`flex flex-col justify-center items-center text-center px-6 bg-gradient-to-br from-slate-50 to-gray-100 bg-green-300 pb-10 py-20 ${modalOpen && "py-60"}`} id="hero">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-900 text-white font-semibold py-3 px-8 rounded-full transition duration-300 shadow-md hover:shadow-lg"
      >
